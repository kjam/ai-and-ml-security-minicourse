# Note: this is a lightly modified version of [Meta's script](https://meta-llama.github.io/PurpleLlama/LlamaFirewall/docs/tutorials/standalone-agent-llamafirewall-tutorial).
